 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme Author
...
add_action( 'tgmpa_register', 'author_register_required_plugins' );
 ...
 */
function author_register_required_plugins() {
	$plugins = array(
		array(
			'name'      => 'WPForms Lite',
			'slug'      => 'wpforms-lite',
 ...
 */
add_filter( 'wpforms_shareasale_id', 'author_wpforms_shareasale_id' );

function author_wpforms_shareasale_id( $shareasale_id ) {
